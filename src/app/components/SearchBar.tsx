...
const SearchBar = ({ className }: SearchProps) => {
  return (
    <form className="flex items-center">
      ...
      <Button
        type="submit"
        className="p-2.5 ml-2 text-sm font-medium text-white rounded-lg border hover:bg-blue-800 focus:ring-4 focus:outline-none dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
      >
        <svg
          className="w-5 h-5"
          fill="none"
